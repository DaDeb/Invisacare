  ...
  mounted() {
    ...
    interact(element).draggable({
      ...
      onend: () => {
        ...
        if (x > interactXThreshold) this.playCard(RIGHT_E);
        else if (x < -interactXThreshold) this.playCard(LEFT_E);
        else if (y > interactYThreshold) this.playCard(DOWN_E);
        else if (y < -interactYThreshold) this.playCard(UP_E);
